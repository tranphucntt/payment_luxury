...
?>
    ...
    <head>
        ...
        <title>Copyright Luxury Travel Co., Ltd(Vietnam)</title>


        <meta http-equiv="Content-Type" content="text/html; charset=iso-8859-1">


        <meta http-equiv="REFRESH" content="30; url=https://luxurytravelvietnam.com/">


        <LINK href="thailh_nghean.css" type=text/css rel=stylesheet>


        <SCRIPT language=javascript src="includes/click.js"></SCRIPT>
...
function getResponseDescription($responseCode) {
    ...
    switch ($responseCode) {
        ...
        case "1" : $result = "Bank system reject"; break;
