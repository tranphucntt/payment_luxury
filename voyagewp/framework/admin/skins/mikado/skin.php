...
class MikadoSkin extends VoyageMikadoSkinAbstract {
    /**
     * Skin constructor. Hooks to voyage_mikado_admin_scripts_init and voyage_mikado_enqueue_admin_styles
     */
    public function __construct() {
        $this->skinName = 'mikado';

        //hook to
        add_action('voyage_mikado_admin_scripts_init', array($this, 'registerStyles'));
        add_action('voyage_mikado_admin_scripts_init', array($this, 'registerScripts'));

        add_action('voyage_mikado_enqueue_admin_styles', array($this, 'enqueueStyles'));
        add_action('voyage_mikado_enqueue_admin_scripts', array($this, 'enqueueScripts'));

        add_action('voyage_mikado_enqueue_meta_box_styles', array($this, 'enqueueStyles'));
        add_action('voyage_mikado_enqueue_meta_box_scripts', array($this, 'enqueueScripts'));
    ...
    public function registerScripts() {
        ...
        foreach ($this->scripts as $scriptHandle => $scriptPath) {
            voyage_mikado_register_skin_script($scriptHandle, $scriptPath, array(), false, true);
        }
    }
    ...
    public function registerStyles() {
        ...
        foreach ($this->styles as $styleHandle => $stylePath) {
            voyage_mikado_register_skin_style($styleHandle, $stylePath);
        }
    ...
    public function renderOptions() {
        ...
        $tab    		= voyage_mikado_get_admin_tab();
        $active_page 	= $voyage_mikado_Framework->mkdOptions->getAdminPageFromSlug($tab);
     ...
     *
*@param VoyageMikadoAdminPage $page current page to load
...
*@param VoyageMikadoAdminPage $page current page to load
    ...
    public function renderImport() { ?>
        <div class="mkdf-options-page mkdf-page">
            <?php $this->getHeader(voyage_mikado_get_theme_info_item('Name'), voyage_mikado_get_theme_info_item('Version'), false); ?>
            <div class="mkdf-page-content-wrapper">
                <div class="mkdf-page-content">
                    <div class="mkdf-page-navigation mkdf-tabs-wrapper vertical left clearfix">
