...
add_action('after_setup_theme', 'voyage_mikado_admin_map_init', 0);

function voyage_mikado_admin_map_init() {

	do_action('voyage_mikado_before_options_map');
	...
	do_action('voyage_mikado_options_map');

	do_action('voyage_mikado_after_options_map');
