...
if ( ! function_exists('voyage_mikado_content_bottom_options_map') ) {

	function voyage_mikado_content_bottom_options_map() {
		...
		$panel_content_bottom = voyage_mikado_add_admin_panel(
			array(
		...
		$enable_content_bottom_area_container = voyage_mikado_add_admin_container(
			array(
				'parent'            => $panel_content_bottom,
	...
	add_action( 'voyage_mikado_options_map', 'voyage_mikado_content_bottom_options_map', 17);
