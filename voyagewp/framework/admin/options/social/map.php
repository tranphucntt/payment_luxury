...
if(!function_exists('voyage_mikado_social_options_map')) {

	function voyage_mikado_social_options_map() {
		 ...
		 * Enable Social Share
		 */
		$panel_social_share = voyage_mikado_add_admin_panel(array(
			'page'  => '_social_page',
		...
		$panel_show_social_share_on = voyage_mikado_add_admin_panel(array(
			'page'            => '_social_page',
		...
		if(voyage_mikado_tours_plugin_installed()) {
			voyage_mikado_add_admin_field(array(
				...
				'default_value' => 'no',
				'label'         => 'Tour Item',
				'description'   => 'Show Social Share for Tour Items',
				'parent'        => $panel_show_social_share_on
			));
			...
			voyage_mikado_add_admin_field(array(
				...
				'default_value' => 'no',
				'label'         => 'Destination',
				'description'   => 'Show Social Share for Destination',
				'parent'        => $panel_show_social_share_on
			));
		}
		 ...
		 */
		$panel_social_networks = voyage_mikado_add_admin_panel(array(
			'page'            => '_social_page',
		...
		$enable_facebook_share_container = voyage_mikado_add_admin_container(array(
		...
		$enable_twitter_share_container = voyage_mikado_add_admin_container(array(
		...
		$enable_google_plus_container = voyage_mikado_add_admin_container(array(
		...
		$enable_linkedin_container = voyage_mikado_add_admin_container(array(
		...
		$enable_tumblr_container = voyage_mikado_add_admin_container(array(
		...
		$enable_pinterest_container = voyage_mikado_add_admin_container(array(
		...
		$enable_vk_container = voyage_mikado_add_admin_container(array(
		...
		if(defined('MIKADOF_TWITTER_FEED_VERSION')) {
			$twitter_panel = voyage_mikado_add_admin_panel(array(
				'title' => 'Twitter',
				'name'  => 'panel_twitter',
				'page'  => '_social_page'
			));

			voyage_mikado_add_admin_twitter_button(array(
				'name'   => 'twitter_button',
		...
		if(defined('MIKADOF_INSTAGRAM_FEED_VERSION')) {
			$instagram_panel = voyage_mikado_add_admin_panel(array(
				'title' => 'Instagram',
				'name'  => 'panel_instagram',
				'page'  => '_social_page'
			));

			voyage_mikado_add_admin_instagram_button(array(
	...
	add_action('voyage_mikado_options_map', 'voyage_mikado_social_options_map', 16);
}