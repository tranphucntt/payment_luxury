...
if(!function_exists('voyage_mikado_map_video_post_meta_box')) {
	/**
	 * Maps video post meta box
	 */
	function voyage_mikado_map_video_post_meta_box() {
		$video_post_format_meta_box = voyage_mikado_add_meta_box(
			array(
				'scope' => array('post'),
		...
		$mkdf_video_embedded_container = voyage_mikado_add_admin_container(
			array(
				'parent'          => $video_post_format_meta_box,
		...
		$mkdf_video_self_hosted_container = voyage_mikado_add_admin_container(
			array(
				'parent'          => $video_post_format_meta_box,
	...
	add_action('voyage_mikado_meta_boxes_map', 'voyage_mikado_map_video_post_meta_box');
}