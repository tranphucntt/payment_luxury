...
if(!function_exists('voyage_mikado_contact_form_7_options_map')) {

    function voyage_mikado_contact_form_7_options_map() {
        ...
        $panel_contact_form_style_1 = voyage_mikado_add_admin_panel(array(
        ...
        $typography_text_group = voyage_mikado_add_admin_group(array(
        ...
        $typography_text_row1 = voyage_mikado_add_admin_row(array(
        ...
        $typography_text_row2 = voyage_mikado_add_admin_row(array(
        ...
        $typography_text_row3 = voyage_mikado_add_admin_row(array(
        ...
        $typography_label_group = voyage_mikado_add_admin_group(array(
        ...
        $typography_label_row1 = voyage_mikado_add_admin_row(array(
        ...
        $typography_label_row2 = voyage_mikado_add_admin_row(array(
        ...
        $background_border_group = voyage_mikado_add_admin_group(array(
        ...
        $background_border_row1 = voyage_mikado_add_admin_row(array(
        ...
        $background_border_row2 = voyage_mikado_add_admin_row(array(
        ...
        $background_border_row3 = voyage_mikado_add_admin_row(array(
        ...
        $padding_group = voyage_mikado_add_admin_group(array(
            'name'        => 'padding_group',
        ...
        $padding_row = voyage_mikado_add_admin_row(array(
            'name'   => 'padding_row',
        ...
        $margin_group = voyage_mikado_add_admin_group(array(
            'name'        => 'margin_group',
        ...
        $margin_row = voyage_mikado_add_admin_row(array(
            'name'   => 'margin_row',
            'parent' => $margin_group
        ));
        ...
        $button_typography_group = voyage_mikado_add_admin_group(array(
        ...
        $button_typography_row1 = voyage_mikado_add_admin_row(array(
        ...
        $button_typography_row2 = voyage_mikado_add_admin_row(array(
        ...
        $button_background_border_group = voyage_mikado_add_admin_group(array(
        ...
        $button_background_border_row1 = voyage_mikado_add_admin_row(array(
        ...
        $button_background_border_row2 = voyage_mikado_add_admin_row(array(
        ...
        $button_background_border_row3 = voyage_mikado_add_admin_row(array(
        ...
        voyage_mikado_add_admin_field(array(
            ...
            'default_value' => 'no',
            'label'         => 'Show Full Width Button',
            'description'   => 'Set this option to "Yes" if you would like the Content Form button to be full width',
        ));

        $panel_contact_form_style_2 = voyage_mikado_add_admin_panel(array(
            'page'  => '_contact_form7_page',
        ...
        $panel_contact_form_style_3 = voyage_mikado_add_admin_panel(array(
            'page'  => '_contact_form7_page',
        ...
        $panel_contact_form_style_4 = voyage_mikado_add_admin_panel(array(
            'page'  => '_contact_form7_page',
    ...
    add_action('voyage_mikado_options_map', 'voyage_mikado_contact_form_7_options_map', 19);
