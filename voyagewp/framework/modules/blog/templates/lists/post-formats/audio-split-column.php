<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
    <div class="mkdf-post-content">
        <?php voyage_mikado_get_module_template_part('templates/lists/parts/image-audio-split-column', 'blog'); ?>
        <div class="mkdf-post-text">
            <div class="mkdf-post-text-inner">
                ...
                ?>
                <div class="mkdf-image-desc-share clearfix">
                ...
                <?php voyage_mikado_get_module_template_part('templates/parts/social-share', 'blog'); ?>
            </div>
        </div>
    </div>
</article>