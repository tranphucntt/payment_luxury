<div class="mkdf-blog-holder mkdf-blog-date-on-side <?php echo esc_attr($blog_classes) ?>" data-blog-type="<?php echo esc_attr($blog_type) ?>" <?php echo esc_attr(voyage_mikado_set_blog_holder_data_params()); ?> >
	<?php
