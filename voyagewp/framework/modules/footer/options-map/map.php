...
if(!function_exists('voyage_mikado_footer_options_map')) {
	/**
	 * Add footer options
	 */
	function voyage_mikado_footer_options_map() {
		...
		$footer_panel = voyage_mikado_add_admin_panel(
			array(
				'title' => 'Footer',
				'name'  => 'footer',
				'page'  => '_footer_page'
		...
		$show_footer_top_container = voyage_mikado_add_admin_container(
			array(
		...
		$show_footer_bottom_container = voyage_mikado_add_admin_container(
			array(
	...
	add_action('voyage_mikado_options_map', 'voyage_mikado_footer_options_map', 10);
