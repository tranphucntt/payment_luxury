...
if(!function_exists('voyage_mikado_logo_options_map')) {

	function voyage_mikado_logo_options_map() {
	...
	add_action('voyage_mikado_options_map', 'voyage_mikado_logo_options_map');
