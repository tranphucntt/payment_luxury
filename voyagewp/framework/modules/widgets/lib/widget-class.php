 ...
 *
 * Class VoyageMikadoWidget
 */
abstract class VoyageMikadoWidget extends WP_Widget {
	/**
	...
	public function form($instance) {
		if(is_array($this->params) && count($this->params)) {
			...
			<p><?php esc_html_e('There are no options for this widget.', 'voyage'); ?></p>
		<?php }
	}
...
$voyage_mikado_Framework = VoyageMikadoFramework::get_instance();
$mkdSkinManager                 = new VoyageMikadoSkinManager();
$voyage_mikado_Framework->setSkin($mkdSkinManager->getSkin());
