 ...
 */
class VoyageMikadoSocialIconWidget extends VoyageMikadoWidget {
	/**
	...
	protected function setParams() {
		$this->params = array_merge(
			voyage_mikado_icon_collections()->getSocialIconWidgetParamsArray(),
			array(
				array(
					'type'        => 'textfield',
					'title'       => 'Link',
	...
	public function widget($args, $instance) {
		...
		<a class="mkdf-social-icon-widget-holder" <?php echo voyage_mikado_get_inline_attr($hover_color, 'data-hover-color'); ?> <?php voyage_mikado_inline_style($social_icon_styles) ?> href="<?php echo esc_html($link); ?>" target="<?php echo esc_attr($target); ?>">
