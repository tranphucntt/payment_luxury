...
if(!function_exists('voyage_mikado_woocommerce_options_map')) {

	/**
	 * Add Woocommerce options page
	 */
	function voyage_mikado_woocommerce_options_map() {
		 ...
		 */
		$panel_product_list = voyage_mikado_add_admin_panel(
			array(
		 ...
		 */
		$panel_single_product = voyage_mikado_add_admin_panel(
			array(
				'page'  => '_woocommerce_page',
	...
	add_action('voyage_mikado_options_map', 'voyage_mikado_woocommerce_options_map', 20);
