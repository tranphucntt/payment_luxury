<?php
namespace Voyage\Modules\ElementsHolderItem;
...
class ElementsHolderItem implements ShortcodeInterface {
		...
		if(function_exists('vc_map')) {
			vc_map(
				array(
					...
					'as_parent'               => array('except' => 'vc_row, vc_accordion, no_cover_boxes'),
	...
	public function render($atts, $content = null) {
		...
		$html = voyage_mikado_get_shortcode_module_template_part('templates/elements-holder-item-template', 'elements-holder', '', $params);
