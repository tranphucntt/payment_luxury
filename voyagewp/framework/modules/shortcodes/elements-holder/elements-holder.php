<?php
namespace Voyage\Modules\ElementsHolder;
...
class ElementsHolder implements ShortcodeInterface {
	...
	public function render($atts, $content = null) {
		...
		$html .= '<div '.voyage_mikado_get_class_attribute($elements_holder_class).' '.voyage_mikado_get_inline_attr($elements_holder_style, 'style').'>';
