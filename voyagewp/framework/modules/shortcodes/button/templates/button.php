<button type="submit" <?php voyage_mikado_inline_style($button_styles); ?> <?php voyage_mikado_class_attribute($button_classes); ?> <?php echo voyage_mikado_get_inline_attrs($button_data); ?> <?php echo voyage_mikado_get_inline_attrs($button_custom_attrs); ?>>
