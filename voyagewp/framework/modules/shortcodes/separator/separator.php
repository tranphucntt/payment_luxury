<?php
namespace Voyage\Modules\Separator;
...
class Separator implements ShortcodeInterface {
	...
	public function render($atts, $content = null) {
		...
		$html = voyage_mikado_get_shortcode_module_template_part('templates/separator-template', 'separator', '', $params);
	...
	private function getSeparatorStyle($params) {
		...
		if($params['width'] !== '') {
			if(voyage_mikado_string_ends_with($params['width'], '%') || voyage_mikado_string_ends_with($params['width'], 'px')) {
		...
		if($params['top_margin'] !== '') {
			if(voyage_mikado_string_ends_with($params['top_margin'], '%') || voyage_mikado_string_ends_with($params['top_margin'], 'px')) {
		...
		if($params['bottom_margin'] !== '') {
			if(voyage_mikado_string_ends_with($params['bottom_margin'], '%') || voyage_mikado_string_ends_with($params['bottom_margin'], 'px')) {
