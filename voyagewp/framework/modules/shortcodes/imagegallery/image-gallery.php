<?php
namespace Voyage\Modules\Shortcodes\ImageGallery;
...
class ImageGallery implements ShortcodeInterface {
    ...
    public function vcMap() {
        ...
        vc_map(array(
            ...
            'params'                    => array(
                ...
                array(
                    'type'        => 'dropdown',
                    'heading'     => 'Hover/Click Action',
                    'param_name'  => 'hover_click_action',
                    'value'       => array(
                    	'None' => 'none',
                        'Open PrettyPhoto'  => 'pretty_photo',
                        'Show Title and Link' => 'title_link'
                    ),
                    'save_always' => true,
                    'dependency'  => array('element' => 'type', 'value' => 'image_grid')
                ),
    ...
    public function render($atts, $content = null) {
        ...
        $html = voyage_mikado_get_shortcode_module_template_part('templates/'.$template, 'imagegallery', '', $params);
