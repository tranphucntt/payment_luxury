<?php
namespace Voyage\Modules\CustomFont;
...
class CustomFont implements ShortcodeInterface {
		...
		vc_map(array(
			...
			'params'                    => array(
				...
				array(
					...
					"value"       => voyage_mikado_get_font_style_array(),
					"description" => ""
				),
				array(
					"type"        => "dropdown",
				...
				array(
					...
					"value"       => voyage_mikado_get_text_transform_array(),
					"description" => ""
				),
				array(
					"type"        => "dropdown",
	...
	public function render($atts, $content = null) {
		...
		$html = voyage_mikado_get_shortcode_module_template_part('templates/custom-font-template', 'customfont', '', $params);
