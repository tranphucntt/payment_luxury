<?php
namespace Voyage\Modules\PieCharts\PieChartWithIcon;
...
class PieChartWithIcon implements ShortcodeInterface {
			...
			'params' => array_merge(
				...
				array(
					array(
						...
						'dependency' => Array('element' => 'icon_pack', 'value' => voyage_mikado_icon_collections()->getIconCollectionsKeys()),
						'group' => 'Design Options',
					),
					array(
						'type' => 'textfield',
	...
	public function render($atts, $content = null)
	{
		...
		$params['active_color'] = $params['active_color'] !== '' ? $params['active_color'] : voyage_mikado_get_first_main_color();
		...
		$html = voyage_mikado_get_shortcode_module_template_part('templates/pie-chart-with-icon', 'piecharts/piechartwithicon', '', $params);
	...
	private function getPieChartIcon($params) {
		...
		$pie_chart_icon = voyage_mikado_icon_collections()->renderIcon( $params[$icon], $params['icon_pack'], $iconStyles );
