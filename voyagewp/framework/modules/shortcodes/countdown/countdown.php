<?php
namespace Voyage\Modules\Counter;
...
class Countdown implements ShortcodeInterface {
	...
	public function vcMap() {
		...
		vc_map( array(
			...
			'base' => $this->getBase(),
			'category' => 'by MIKADO',
			'admin_enqueue_css' => array(voyage_mikado_get_skin_uri().'/assets/css/mkdf-vc-extend.css'),
	...
	public function render($atts, $content = null)
	{
		...
		$html = voyage_mikado_get_shortcode_module_template_part('templates/countdown-template', 'countdown', '', $params);
