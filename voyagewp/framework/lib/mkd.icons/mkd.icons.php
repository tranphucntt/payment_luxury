...
/*
  Class: VoyageMikadoIconCollections
...
class VoyageMikadoIconCollections {
	...
	private function initIconCollections() {
		$this->addIconCollection('font_awesome', new VoyageMikadoIconsFontAwesome("Font Awesome", "fa_icon"));
		$this->addIconCollection('font_elegant', new VoyageMikadoIconsFontElegant("Font Elegant", "fe_icon"));
		$this->addIconCollection('ion_icons', new VoyageMikadoIonIcons("Ion Icons", "ion_icon"));
		$this->addIconCollection('linea_icons', new VoyageMikadoLineaIcons('Linea Icons', 'linea_icon'));
		$this->addIconCollection('linear_icons', new VoyageMikadoLinearIcons('Linear Icons', 'linear_icon'));
		$this->addIconCollection('simple_line_icons', new VoyageMikadoSimpleLineIcons('Simple Line Icons',
			'simple_line_icons'));
		$this->addIconCollection('dripicons', new VoyageMikadoDripicons('Dripicons', 'dripicon'));
	}
	...
	public function getIconCollectionIcons(iVoyageMikadoIconCollection $collection) {
...
$voyage_mikado_IconCollections = VoyageMikadoIconCollections::get_instance();