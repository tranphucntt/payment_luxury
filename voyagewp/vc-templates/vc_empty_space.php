...
foreach($sizes as $size) {
	if($$size !== '') {
		$data_attr['data-'.$size] = voyage_mikado_filter_px($$size);
	}
}

$data_attr['data-original-height'] = voyage_mikado_filter_px($height);

?>
<div <?php echo voyage_mikado_get_inline_attrs($data_attr); ?> class="<?php echo esc_attr(trim($css_class)); ?>" <?php print $inline_css; ?> >
